...
<body>
    ...
    <img src="..\images\South Harmon Institue of Technology (1).png" alt="SHIT Logo">
        <h1>Welcome, <?php echo $admin->getFirstName() . ' ' . $admin->getLastName() ?></h1>
        <table>
    <tr>
        <td><button onclick="window.location.href='admin_books.php'"><i class="fas fa-book"></i> View available books and add a book</button></td>
        <td><button onclick="window.location.href='admin_cds.php'"><i class="fas fa-compact-disc"></i> View available music CDs and add a CD</button></td>
    </tr>
    <tr>
    ...
    <tr>
        <td><button onclick="window.location.href='page_transfers.php'"><i class="fas fa-exchange-alt"></i> Request a book transfer</button></td>
