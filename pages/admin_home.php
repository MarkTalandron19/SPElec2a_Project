...
<body>
    ...
    <img src="..\images\South Harmon Institue of Technology (1).png" alt="SHIT Logo">
        ...
        <table>
            <tr>
                <td><i class="fas fa-book"></i><a href="admin_books.php">View available books and add a book</a></td>
                <td><i class="fas fa-compact-disc"></i><a href="admin_cds.php">View available music CDs and add a CD</a></td>
            </tr>
            <tr>
